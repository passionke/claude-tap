...
PyPI distribution: [**claw-tap**](https://pypi.org/project/claw-tap/) · source: [**passionke/claude-tap**](https://github.com/passionke/claude-tap)
...
Issues and pull requests: [passionke/claude-tap](https://github.com/passionke/claude-tap). See [CONTRIBUTING.md](CONTRIBUTING.md).

## License

MIT — see [LICENSE](LICENSE).

This repository is a fork of [liaohch3/claude-tap](https://github.com/liaohch3/claude-tap). The MIT license requires retaining the upstream copyright notice in `LICENSE`; fork-specific changes are maintained under [passionke/claude-tap](https://github.com/passionke/claude-tap) and published on PyPI as `claw-tap`.
